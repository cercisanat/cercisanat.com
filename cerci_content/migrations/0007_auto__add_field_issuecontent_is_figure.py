...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueContent.is_figure'
        db.add_column(u'cerci_content_issuecontent', 'is_figure',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueContent.is_figure'
        db.delete_column(u'cerci_content_issuecontent', 'is_figure')
    ...
    models = {
        ...
        u'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 12, 0, 0)'}),
        ...
        u'cerci_content.issuecontent': {
            ...
            'genres': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['cerci_content.Genre']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
