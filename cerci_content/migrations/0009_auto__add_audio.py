...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Audio'
        db.create_table(u'cerci_content_audio', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('audio', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'cerci_content', ['Audio'])

        # Adding M2M table for field audios on 'IssueContent'
        db.create_table(u'cerci_content_issuecontent_audios', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issuecontent', models.ForeignKey(orm[u'cerci_content.issuecontent'], null=False)),
            ('audio', models.ForeignKey(orm[u'cerci_content.audio'], null=False))
        ))
        db.create_unique(u'cerci_content_issuecontent_audios', ['issuecontent_id', 'audio_id'])


    def backwards(self, orm):
        # Deleting model 'Audio'
        db.delete_table(u'cerci_content_audio')

        # Removing M2M table for field audios on 'IssueContent'
        db.delete_table('cerci_content_issuecontent_audios')
    ...
    models = {
        ...
        u'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)'}),
