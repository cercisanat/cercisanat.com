...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Genre.spotting_order'
        db.add_column('cerci_content_genre', 'spotting_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Genre.spotting_order'
        db.delete_column('cerci_content_genre', 'spotting_order')
