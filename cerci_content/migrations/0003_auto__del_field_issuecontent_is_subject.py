...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IssueContent.is_subject'
        db.delete_column('cerci_content_issuecontent', 'is_subject')


    def backwards(self, orm):
        # Adding field 'IssueContent.is_subject'
        db.add_column('cerci_content_issuecontent', 'is_subject',
