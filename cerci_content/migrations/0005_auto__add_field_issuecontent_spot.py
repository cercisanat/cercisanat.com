...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueContent.spot'
        db.add_column('cerci_content_issuecontent', 'spot',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueContent.spot'
        db.delete_column('cerci_content_issuecontent', 'spot')
    ...
    models = {
        ...
        'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
