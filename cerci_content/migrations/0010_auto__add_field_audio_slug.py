...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Audio.slug'
        db.add_column(u'cerci_content_audio', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='pink', unique=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audio.slug'
        db.delete_column(u'cerci_content_audio', 'slug')
