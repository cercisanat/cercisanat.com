...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cerci_content_genre', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cerci_content_genre', 'description')
    ...
    models = {
        ...
        'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 9, 0, 0)'}),
