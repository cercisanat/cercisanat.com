...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UnsubscribeToken.is_used'
        db.delete_column(u'cerci_newsletters_unsubscribetoken', 'is_used')


    def backwards(self, orm):
        # Adding field 'UnsubscribeToken.is_used'
        db.add_column(u'cerci_newsletters_unsubscribetoken', 'is_used',
