...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UnsubscribeToken', fields ['subscriber']
        db.create_unique(u'cerci_newsletters_unsubscribetoken', ['subscriber_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UnsubscribeToken', fields ['subscriber']
        db.delete_unique(u'cerci_newsletters_unsubscribetoken', ['subscriber_id'])
    ...
    models = {
        ...
        u'cerci_newsletters.unsubscribetoken': {
            ...
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cerci_newsletters.Subscriber']", 'unique': 'True'}),
