...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cerci_issue_issue2content', 'order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Issue2Content.order'
        db.alter_column('cerci_issue_issue2content', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
