...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cover_design on 'Issue'
        db.create_table('cerci_issue_issue_cover_design', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['cerci_issue.issue'], null=False)),
            ('author', models.ForeignKey(orm['cerci_content.author'], null=False))
        ))
        db.create_unique('cerci_issue_issue_cover_design', ['issue_id', 'author_id'])


    def backwards(self, orm):
        # Removing M2M table for field cover_design on 'Issue'
        db.delete_table('cerci_issue_issue_cover_design')
    ...
    models = {
        ...
        'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 25, 0, 0)'}),
        ...
        'cerci_issue.issue': {
            ...
            'cover_design': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cerci_content.Author']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 25, 0, 0)'}),
        ...
        'cerci_issue.issuefile': {
            'Meta': {'object_name': 'IssueFile'},
            'format': ('django.db.models.fields.CharField', [], {'default': "'ePub3'", 'max_length': '16'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cerci_issue.Issue']"}),
            'issue_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
