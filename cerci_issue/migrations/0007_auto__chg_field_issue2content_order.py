...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue2Content.order'
        db.alter_column('cerci_issue_issue2content', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Issue2Content.order'
        raise RuntimeError("Cannot reverse this migration. 'Issue2Content.order' and its values cannot be restored.")
    ...
    models = {
        ...
        'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
