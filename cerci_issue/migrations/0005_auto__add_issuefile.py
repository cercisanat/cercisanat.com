...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueFile'
        db.create_table('cerci_issue_issuefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cerci_issue.Issue'])),
            ('issue_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('format', self.gf('django.db.models.fields.CharField')(default='ePub3', max_length=16)),
        ))
        db.send_create_signal('cerci_issue', ['IssueFile'])


    def backwards(self, orm):
        # Deleting model 'IssueFile'
        db.delete_table('cerci_issue_issuefile')
    ...
    models = {
        ...
        'cerci_content.author': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 19, 0, 0)'}),
