...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.published_at'
        db.alter_column('cerci_issue_issue', 'published_at', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Issue.published_at'
        db.alter_column('cerci_issue_issue', 'published_at', self.gf('django.db.models.fields.DateTimeField')(null=True))
